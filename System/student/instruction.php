...
<head>
  ...
  <title>MITS | Examination Instructions</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>MITS-Examination</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
     ...
     <ul class="treeview-menu active">
            <li class="active"><a href="instruction.php"><i class="fa fa-circle"></i> Take Test</a></li>
          </ul>
        </li>
			  <li class="treeview">
          <a href="#">
...
<div class="callout callout-info">
    ...
    <ul>
	<li>The examination contain 60 questions</li>
	<li>Each question carries 1 mark</li>
	<li>You are required to answer all questions</li>
	<li>Passmark is 30, below that you have failed the exam</li>
	<li><b>DO NOT refresh the page during exam</b></li>
	</ul>
	  ...
	  print '
	<div class="callout callout-info">
        Click'; ?> <a onclick="return confirm('Are you sure to begin Examination ?');" href="exam.php">here</a><?php print ' to begin the assessment
      </div>';
	  ?>
